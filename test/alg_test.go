...
func BenchmarkBigNum(b *testing.B) {
	...
	b.Run("Sub", func(b *testing.B) {
		var x, y math.BigNum
		n1 := x.FromString("13696391639698649264985275947507057027074290650924860609265757858587592645969465946273658256283523")
		n2 := y.FromString("89365965965964956925649976592465982659826557859629465984265984264596259642956924659645")
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			x.Sub(n1,n2)
		}
	...
	b.Run("Std Lib Big", func(b *testing.B) {
		var x, y bmath.Int
	...
	b.Run("Except", func(b *testing.B) {
		var x, y math.BigNum
		n1 := x.FromString("13696391639698649264985275947507057027074290650924860609265757858587592645969465946")
		n2 := y.FromString("89365965965964956925649976592465982659826557859629465984265984264596259642956924659645")
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			x.Except(n1,n2)
...
func BenchmarkFormat(b *testing.B) {
	b.Run("Decode", func(b *testing.B) {
		...
		b.ResetTimer()
		for i := 0; i < b.N; i++ {
			x.FromString("13696391639698649264985275947507057027074290650924860609265757858587592645969465946")
		}
	})
